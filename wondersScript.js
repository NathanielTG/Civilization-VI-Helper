document.addEventListener("DOMContentLoaded", function () { 
    ...
    const wonders = [
        ...
        { name: "Torre de Belem", victory: ["all"], tier: "good", description: "International {trade_icon} Trade Routes from this city receive +2 {gold_icon} Gold for every Luxury Resource at the destination.<br><br>When Torre de Belem is constructed, cities not on your home continent receive the lowest {production_icon} Production cost building they can currently construct.<br><br>+5 {gold_icon} Gold and +1 {admiral_icon} Great Admiral point per turn.<br><br>Must be built on Coast adjacent to land and a Harbor. Cannot be built on a Lake." },
