document.addEventListener("DOMContentLoaded", function () {
    ...
    function renderLeaders(selectedPrimaryVictories) {
        ...
        leadersData.forEach(leader => {
            ...
            if (hasPrimaryMatch) {
                if (leader.primaryVictories.length === selectedPrimaryVictories.length && 
                    leader.primaryVictories.every(victory => selectedPrimaryVictories.includes(victory))) {
                        // Apply teal outline for exact matches
                        leaderImage.classList.add("exact-match-teal");
                    } else {
